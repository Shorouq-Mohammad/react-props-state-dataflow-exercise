...
class App extends Component {
  ...
  generateCompanyTags(companies){
      ...
      for(let company of companies){
        arr.push(<Company name={company.name} revenue={company.revenue} key={company.name}/>)
      }
      return arr
    }
    ...
    return (
      <div>
        ...
        <div className="ex-space">
          ...
          {this.state.currentPage === "Landing" ? <Landing user={this.state.user} hottest={this.state.store.find(s=> s.hottest)} /> : <Home store={this.state.store} />}
          </div>
        </div>
